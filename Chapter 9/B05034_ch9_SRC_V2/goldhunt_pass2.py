...
This module illustrates the second optimization pass for the Gold Hunt
program.

Here, we use goldhunt_pass1.py as the base. and do further improvements.
Changes are done in find_coins that avoid using 'dots'.
