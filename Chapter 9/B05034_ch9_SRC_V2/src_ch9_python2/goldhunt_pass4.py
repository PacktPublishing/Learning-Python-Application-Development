...
This module illustrates the fourth optimization pass for the Gold Hunt
program.

This uses goldhunt_pass3.py as the base and improves the performance
further. It optimizes the function generate_random_points. Instead of
using math and random modules from the standard library, it uses the
equivalent functions form NumPy library
