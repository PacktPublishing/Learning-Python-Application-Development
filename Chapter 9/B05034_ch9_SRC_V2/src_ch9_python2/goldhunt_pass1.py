...
This module illustrates the first optimization pass for the Gold Hunt
program.

Here, we change the algorithm by changing the way we compare the
distance. Instead of a square root, we compare the square of the distance.
See the second chapter on performance improvement for more details
